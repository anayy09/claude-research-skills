...
[![Version](https://img.shields.io/badge/version-2.0.2-6E56CF)](../CHANGELOG.md)
...
- **2.0.2**: The description is trimmed below the 1024-character cap that skill portals enforce on the `description` field, by compressing the prose and dropping trigger phrases that duplicated others. Behavior is unchanged.
